  ...
  return (
    <main>
      ...
      <section className="section">
        ...
        <p className="center-text">Most reminder apps focus on alerts. Tick focuses on people. We believe reminders should motivate, not overwhelm.</p>
      </section>

      <section className="section dark">
        <h2>The Problem With Traditional Reminders</h2>
        <div className="grid">
          <div className="card"><h3>Notification Fatigue</h3><p>Endless alerts eventually get ignored. Reminders lose their meaning.</p></div>
          <div className="card"><h3>No Motivation</h3><p>Being reminded doesn’t mean being encouraged to actually do the task.</p></div>
          <div className="card"><h3>No Reward</h3><p>Completing tasks feels empty when there’s nothing to gain.</p></div>
        </div>
      </section>

      <section className="section">
        <h2>How Tick Solves This</h2>
        <p className="center-text">Tick transforms reminders into a rewarding system that values consistency, progress, and personal growth.</p>
      </section>

      <section className="section dark">
        <h2>Core Features</h2>
        <div className="grid">
          <div className="card"><h3>Smart Reminders</h3><p>Clean, minimal reminders that respect your attention.</p></div>
          <div className="card"><h3>Point System</h3><p>Earn points for every completed reminder and build positive momentum.</p></div>
          <div className="card"><h3>Customization</h3><p>Use your points to unlock themes, UI upgrades and future features.</p></div>
        </div>
      </section>
      ...
      <section className="section dark">
        ...
        <p className="center-text muted">We want productivity to feel calm, motivating and sustainable.</p>
      </section>

      <section className="section">
        <h2>What’s Coming</h2>
        <div className="grid">
          <div className="card"><h3>Mobile Apps</h3><p>Native iOS and Android apps with full sync.</p></div>
          <div className="card"><h3>Advanced Rewards</h3><p>Streak bonuses, seasonal themes and more unlockables.</p></div>
          <div className="card"><h3>Cloud Sync</h3><p>Access your reminders securely across all devices.</p></div>
        </div>
      </section>

      <footer>
        <p>© 2026 Tick Reminder. All rights reserved.</p>
        <p style={{ marginTop: '10px', fontSize: '0.8rem', color: '#7c7cff', fontWeight: 'bold', letterSpacing: '1px' }}>
          DEVELOPED BY FLEXA
        </p>
      </footer>
      ...
      {showCookie && (
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '0.9rem', color: '#eaeaf0' }}>Size daha iyi bir deneyim sunmak için çerezleri kullanıyoruz.</p>
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .card { background: #141428; padding: 28px; border-radius: 18
